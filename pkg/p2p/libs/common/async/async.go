...
// abort: tells Parallel to return, if or not all tasks have completed.
...
// Reap NOTE: Not concurrency safe.
// Write results to trs.results without waiting for all tasks to complete.
...
// Wait NOTE: Not concurrency safe.
...
// FirstValue Returns the first most (by task index) error as
...
// FirstError Returns the first most (by task index) error as
// discovered by all previous Reap() calls.
