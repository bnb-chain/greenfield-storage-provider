...
import (
	...
	spbytes "github.com/bnb-chain/greenfield-storage-provider/pkg/p2p/libs/common/bytes"
)
...
type lazyBlockHash struct {
	block interface{ Hash() spbytes.HexBytes }
	out   string
}
...
func LazyBlockHash(block interface{ Hash() spbytes.HexBytes }) fmt.Stringer {
