...
// NextWait Blocking implementation of Next().
...
// Next Nonblocking, may return nil if at the end.
...
// Prev Nonblocking, may return nil if at the end.
...
// New Return CList with MaxLength. CList will panic if it goes beyond MaxLength.
...
// Remove CONTRACT: Caller must call e.DetachPrev() and/or e.DetachNext() to avoid memory leaks.
