...
// UploadPayLoadState includes the state that upload payload using
var UploadPayLoadState = map[string]bool{
	types.JOB_STATE_CREATE_OBJECT_DONE:     true,
	types.JOB_STATE_UPLOAD_PAYLOAD_INIT:    true,
	types.JOB_STATE_UPLOAD_PRIMARY_DOING:   true,
	types.JOB_STATE_UPLOAD_PRIMARY_DONE:    true,
	types.JOB_STATE_UPLOAD_SECONDARY_INIT:  true,
	types.JOB_STATE_UPLOAD_SECONDARY_DOING: true,
	types.JOB_STATE_UPLOAD_SECONDARY_DONE:  true,
	types.JOB_STATE_SEAL_OBJECT_INIT:       true,
	types.JOB_STATE_SEAL_OBJECT_TX_DOING:   true,
	types.JOB_STATE_SEAL_OBJECT_DONE:       true,
}
...
var UploadPayLoadFsmCallBack = fsm.Callbacks{
	...
	ActionBeforeEventAll:                     ShowJobInfo,
	ActionAfterEventAll:                      ShowJobInfo,
}
