...
var (
	ErrRepeatedTask         = gfsperrors.Register(P2PModularName, http.StatusBadRequest, 70001, "request repeated")
	ErrInsufficientApproval = gfsperrors.Register(P2PModularName, http.StatusNotFound, 70002, "insufficient approvals as secondary sp")
)
