...
var (
	ErrDanglingPointer      = gfsperrors.Register(ExecuteModularName, http.StatusNotFound, 40001, "OoooH.... request lost")
	ErrInsufficientApproval = gfsperrors.Register(ExecuteModularName, http.StatusInternalServerError, 40002, "insufficient approvals from p2p")
	ErrUnsealed             = gfsperrors.Register(ExecuteModularName, http.StatusInternalServerError, 40001, "seal object on chain failed")
	ErrExhaustedApproval    = gfsperrors.Register(ExecuteModularName, http.StatusInternalServerError, 40004, "approvals exhausted")
	ErrInvalidIntegrity     = gfsperrors.Register(ExecuteModularName, http.StatusNotAcceptable, 40006, "secondary integrity hash verification failed")
	ErrGfSp                 = gfsperrors.Register(ExecuteModularName, http.StatusNotAcceptable, 45206, "secondary integrity hash verification failed")
)
