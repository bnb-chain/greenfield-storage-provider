...
var (
	ErrUnsupportedAuthType = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20001, "unsupported auth op type")
	ErrMismatchSp          = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20002, "mismatched primary sp")
	ErrNotCreatedState     = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20003, "object has not been created state")
	ErrNotSealedState      = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20004, "object has not been sealed")
	ErrPaymentState        = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20005, "payment account is not active")
	ErrConsensus           = gfsperrors.Register(AuthorizationModularName, http.StatusInternalServerError, 25002, "server slipped away, try again later")
	ErrNoSuchAccount       = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20006, "no such account")
	ErrNoSuchBucket        = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20007, "no such bucket")
	ErrRepeatedBucket      = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20008, "repeated bucket")
	ErrRepeatedObject      = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20009, "repeated object")
	ErrNoPermission        = gfsperrors.Register(AuthorizationModularName, http.StatusBadRequest, 20010, "no permission")
)
...
func (a *AuthorizeModular) Name() string {
	return AuthorizationModularName
}
