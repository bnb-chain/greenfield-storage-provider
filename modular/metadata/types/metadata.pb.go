...
type GfSpGetBucketReadQuotaRequest struct {
	// bucket info from the mechain chain
	BucketInfo *types.BucketInfo `protobuf:"bytes,1,opt,name=bucket_info,json=bucketInfo,proto3" json:"bucket_info,omitempty"`
...
type GfSpGetBucketReadQuotaResponse struct {
	...
	// charged_quota_size is the mechain chain bucket info's read quota size
...
type GfSpGetLatestBucketReadQuotaRequest struct {
	// bucket id from the mechain chain
...
type GfSpVerifyPermissionByIDRequest struct {
	...
	ResourceType resource.ResourceType `protobuf:"varint,2,opt,name=resource_type,json=resourceType,proto3,enum=mechain.resource.ResourceType" json:"resource_type,omitempty"`
	...
	ActionType types4.ActionType `protobuf:"varint,4,opt,name=action_type,json=actionType,proto3,enum=mechain.permission.ActionType" json:"action_type,omitempty"`
}
...
type GfSpVerifyPermissionByIDResponse struct {
	...
	Effect types4.Effect `protobuf:"varint,1,opt,name=effect,proto3,enum=mechain.permission.Effect" json:"effect,omitempty"`
}
...
type GfSpListObjectPoliciesRequest struct {
	...
	BucketName string `protobuf:"bytes,2,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"`
	// action_type defines the requested action type of permission
	ActionType types4.ActionType `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3,enum=mechain.permission.ActionType" json:"action_type,omitempty"`
	// limit sets the limit of keys returned in the response
	Limit uint32 `protobuf:"varint,4,opt,name=limit,proto3" json:"limit,omitempty"`
	// start_after is where you want to start listing from
...
var fileDescriptor_7cdcff708e247f22 = []byte{
	...
	,
}
