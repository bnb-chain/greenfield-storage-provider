...
var (
	ErrDanglingTask     = gfsperrors.Register(ManageModularName, http.StatusNotFound, 60001, "OoooH... request lost")
	ErrRepeatedTask     = gfsperrors.Register(ManageModularName, http.StatusBadRequest, 60002, "request repeated")
	ErrExceedTask       = gfsperrors.Register(ManageModularName, http.StatusInsufficientStorage, 60003, "OoooH... request exceed, try again later")
	ErrCanceledTask     = gfsperrors.Register(ManageModularName, http.StatusBadRequest, 60004, "task canceled")
	ErrNoTaskMatchLimit = gfsperrors.Register(ManageModularName, http.StatusNotFound, 60005, "no task to dispatch below the require limits")
	ErrFutureSupport    = gfsperrors.Register(ManageModularName, http.StatusNotFound, 60006, "future support")
)
