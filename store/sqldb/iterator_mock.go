...
func (m *MockIterator) Key() interface{} {
	m.ctrl.T.Helper()
...
func (m *MockIterator) Value() interface{} {
	m.ctrl.T.Helper()
...
func (m *MockIteratee) NewIterator(start interface{}) Iterator {
	m.ctrl.T.Helper()
...
func (mr *MockIterateeMockRecorder) NewIterator(start interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
