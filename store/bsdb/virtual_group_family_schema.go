...
type VirtualGroupFamily struct {
	...
	GlobalVirtualGroupFamilyId uint32         `gorm:"column:global_virtual_group_family_id;type:BINARY(32);index:idx_vgf_id"`
	GlobalVirtualGroupIds      []uint32       `gorm:"column:global_virtual_group_ids"`
