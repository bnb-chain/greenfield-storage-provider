...
type MetadataAPI interface {
	...
	ListBucketReadQuota(ctx context.Context, yearMonth string, offset, limit uint32, opts ...grpc.DialOption) (map[string]*types.GfSpGetBucketReadQuotaResponse, error)
