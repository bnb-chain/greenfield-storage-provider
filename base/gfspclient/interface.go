...
type SignerAPI interface {
	...
	SignRecoveryTask(ctx context.Context, recoveryTask coretask.RecoveryPieceTask, option ...grpc.DialOption) ([]byte, error)
	...
	SignMigrateGVG(ctx context.Context, task *gfsptask.GfSpMigrateGVGTask, option ...grpc.DialOption) ([]byte, error)
