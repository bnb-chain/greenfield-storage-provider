...
var (
	ErrReplicatePieceApprovalTaskDangling = gfsperrors.Register(BaseCodeSpace, http.StatusInternalServerError, 99701, "OoooH... request lost")
)
...
func (g *GfSpBaseApp) GfSpAskSecondaryReplicatePieceApproval(
	...
	*gfspserver.GfSpAskSecondaryReplicatePieceApprovalResponse,
	...
	if task == nil {
		log.Error("failed to ask replicate piece approval, task pointer dangling")
