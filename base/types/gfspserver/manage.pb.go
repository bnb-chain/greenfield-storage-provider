...
type GfSpNotifPreMigrateBucketRequest struct {
...
func (m *GfSpNotifPreMigrateBucketRequest) Reset()         { *m = GfSpNotifPreMigrateBucketRequest{} }
func (m *GfSpNotifPreMigrateBucketRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpNotifPreMigrateBucketRequest) ProtoMessage()    {}
func (*GfSpNotifPreMigrateBucketRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7801aa704e62bc53, []int{10}
}
func (m *GfSpNotifPreMigrateBucketRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpNotifPreMigrateBucketRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpNotifPreMigrateBucketRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpNotifPreMigrateBucketRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpNotifPreMigrateBucketRequest.Merge(m, src)
}
func (m *GfSpNotifPreMigrateBucketRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpNotifPreMigrateBucketRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpNotifPreMigrateBucketRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpNotifPreMigrateBucketRequest proto.InternalMessageInfo

func (m *GfSpNotifPreMigrateBucketRequest) GetBucketId() uint64 {
	if m != nil {
		return m.BucketId
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*GfSpNotifPreMigrateBucketRequest)(nil), "base.types.gfspserver.GfSpNotifPreMigrateBucketRequest")
...
var fileDescriptor_7801aa704e62bc53 = []byte{
	...
	,
}
...
type GfSpManageServiceClient interface {
	...
	GfSpNotifyPreMigrateBucketAndDeductQuota(ctx context.Context, in *GfSpNotifPreMigrateBucketRequest, opts ...grpc.CallOption) (*GfSpNotifyPreMigrateBucketResponse, error)
...
func (c *gfSpManageServiceClient) GfSpNotifyPreMigrateBucketAndDeductQuota(ctx context.Context, in *GfSpNotifPreMigrateBucketRequest, opts ...grpc.CallOption) (*GfSpNotifyPreMigrateBucketResponse, error) {
...
type GfSpManageServiceServer interface {
	...
	GfSpNotifyPreMigrateBucketAndDeductQuota(context.Context, *GfSpNotifPreMigrateBucketRequest) (*GfSpNotifyPreMigrateBucketResponse, error)
...
func (*UnimplementedGfSpManageServiceServer) GfSpNotifyPreMigrateBucketAndDeductQuota(ctx context.Context, req *GfSpNotifPreMigrateBucketRequest) (*GfSpNotifyPreMigrateBucketResponse, error) {
...
func _GfSpManageService_GfSpNotifyPreMigrateBucketAndDeductQuota_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpNotifPreMigrateBucketRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpManageServiceServer).GfSpNotifyPreMigrateBucketAndDeductQuota(ctx, req.(*GfSpNotifPreMigrateBucketRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *GfSpNotifPreMigrateBucketRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpNotifPreMigrateBucketRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpNotifPreMigrateBucketRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpNotifPreMigrateBucketRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpNotifPreMigrateBucketRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpNotifPreMigrateBucketRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpNotifPreMigrateBucketRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
