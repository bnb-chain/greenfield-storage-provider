...
type MigrateBucketProgressMeta struct {
	...
	MigrationState         uint32 `protobuf:"varint,3,opt,name=migration_state,json=migrationState,proto3" json:"migration_state,omitempty"`
	GvgTotalNum            uint32 `protobuf:"varint,4,opt,name=gvg_total_num,json=gvgTotalNum,proto3" json:"gvg_total_num,omitempty"`
	GvgNumMigratedFinished uint32 `protobuf:"varint,5,opt,name=gvg_num_migrated_finished,json=gvgNumMigratedFinished,proto3" json:"gvg_num_migrated_finished,omitempty"`
	GvgNumGcFinished       uint32 `protobuf:"varint,6,opt,name=gvg_num_gc_finished,json=gvgNumGcFinished,proto3" json:"gvg_num_gc_finished,omitempty"`
	...
	LastGcObjectId         uint64 `protobuf:"varint,9,opt,name=last_gcObject_id,json=lastGcObjectId,proto3" json:"last_gcObject_id,omitempty"`
...
func (m *MigrateBucketProgressMeta) GetMigrationState() uint32 {
	if m != nil {
...
func (m *MigrateBucketProgressMeta) GetGvgTotalNum() uint32 {
	if m != nil {
		return m.GvgTotalNum
	}
	return 0
}

func (m *MigrateBucketProgressMeta) GetGvgNumMigratedFinished() uint32 {
	if m != nil {
		return m.GvgNumMigratedFinished
	}
	return 0
}

func (m *MigrateBucketProgressMeta) GetGvgNumGcFinished() uint32 {
	if m != nil {
...
var fileDescriptor_7801aa704e62bc53 = []byte{
	...
	,
}
...
func (m *MigrateBucketProgressMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GvgNumGcFinished != 0 {
		i = encodeVarintManage(dAtA, i, uint64(m.GvgNumGcFinished))
		i--
		dAtA[i] = 0x30
	}
	if m.GvgNumMigratedFinished != 0 {
		i = encodeVarintManage(dAtA, i, uint64(m.GvgNumMigratedFinished))
		i--
		dAtA[i] = 0x28
	}
	if m.GvgTotalNum != 0 {
		i = encodeVarintManage(dAtA, i, uint64(m.GvgTotalNum))
		i--
		dAtA[i] = 0x20
	}
	if m.MigrationState != 0 {
		i = encodeVarintManage(dAtA, i, uint64(m.MigrationState))
		i--
		dAtA[i] = 0x18
	}
...
func (m *MigrateBucketProgressMeta) Size() (n int) {
	...
	if m.MigrationState != 0 {
		n += 1 + sovManage(uint64(m.MigrationState))
	}
	if m.GvgTotalNum != 0 {
		n += 1 + sovManage(uint64(m.GvgTotalNum))
	}
	if m.GvgNumMigratedFinished != 0 {
		n += 1 + sovManage(uint64(m.GvgNumMigratedFinished))
	}
	if m.GvgNumGcFinished != 0 {
		n += 1 + sovManage(uint64(m.GvgNumGcFinished))
	}
	if m.PreDeductedQuota != 0 {
...
func (m *MigrateBucketProgressMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GvgTotalNum", wireType)
			}
			m.GvgTotalNum = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GvgTotalNum |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GvgNumMigratedFinished", wireType)
			}
			m.GvgNumMigratedFinished = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowManage
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GvgNumMigratedFinished |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GvgNumGcFinished |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
