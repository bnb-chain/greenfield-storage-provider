...
type GfSpSignRequest struct {
	...
	//	*GfSpSignRequest_GfspMigrateBucketStatus
...
type GfSpSignRequest_GfspMigrateBucketStatus struct {
	GfspMigrateBucketStatus *gfsptask.GfSpBucketMigrationStatus `protobuf:"bytes,24,opt,name=gfsp_migrate_bucket_status,json=gfspMigrateBucketStatus,proto3,oneof" json:"gfsp_migrate_bucket_status,omitempty"`
}
...
func (*GfSpSignRequest_GfspMigrateBucketStatus) isGfSpSignRequest_Request()        {}
...
func (m *GfSpSignRequest) GetGfspMigrateBucketStatus() *gfsptask.GfSpBucketMigrationStatus {
	if x, ok := m.GetRequest().(*GfSpSignRequest_GfspMigrateBucketStatus); ok {
		return x.GfspMigrateBucketStatus
	}
	return nil
}
...
func (*GfSpSignRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GfSpSignRequest_GfspMigrateBucketStatus)(nil),
	}
}
...
var fileDescriptor_16c5938400680494 = []byte{
	...
	,
}
...
func (m *GfSpSignRequest_GfspMigrateBucketStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_GfspMigrateBucketStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.GfspMigrateBucketStatus != nil {
		{
			size, err := m.GfspMigrateBucketStatus.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_GfspMigrateBucketStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.GfspMigrateBucketStatus != nil {
		l = m.GfspMigrateBucketStatus.Size()
		n += 2 + l + sovSign(uint64(l))
	}
	return n
}
...
func (m *GfSpSignRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GfspMigrateBucketStatus", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &gfsptask.GfSpBucketMigrationStatus{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_GfspMigrateBucketStatus{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSign(dAtA[iNdEx:])
