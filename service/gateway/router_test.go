...
func TestRouters(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			router:           gwRouter,
			method:           http.MethodGet,
			url:              scheme + bucketName + "." + testDomain + "/" + objectName + "?" + model.GetObjectMetaByNameQuery,
			shouldMatch:      true,
		...
		},
		{
			...
			router:           gwRouter,
			method:           http.MethodGet,
			url:              scheme + testDomain + "/" + bucketName + "/" + objectName + "?" + model.GetObjectMetaByNameQuery,
			shouldMatch:      true,
			wantedRouterName: getObjectMetaByNameRouterName,
		},
		{
			...
			router:           gwRouter,
			method:           http.MethodGet,
			url:              scheme + bucketName + "." + testDomain + "?" + model.GetBucketMetaByNameQuery,
			shouldMatch:      true,
		...
		},
		{
			...
			router:           gwRouter,
			method:           http.MethodGet,
			url:              scheme + testDomain + "/" + bucketName + "?" + model.GetBucketMetaByNameQuery,
			shouldMatch:      true,
			wantedRouterName: getBucketMetaByNameRouterName,
		},
		{
