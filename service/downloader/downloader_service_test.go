...
// 	d, err := NewDownloaderService(&DownloaderConfig{GRPCAddress: model.DownloaderGRPCAddress})
// 	assert.NoError(t, err)
// 	assert.NotNil(t, d)
//
// 	pieces, err := d.DownloadPieceInfo(123, 50*1024*1024, 0, 100)
// 	assert.Equal(t, nil, err)
// 	assert.Equal(t, 1, len(pieces))
// 	assert.Equal(t, piecestore.EncodeSegmentPieceKey(123, uint32(0)), pieces[0].pieceKey)
//
// 	pieces, err = d.DownloadPieceInfo(123, 50*1024*1024, 16*1024*1024, 33*1024*1024)
// 	assert.Equal(t, nil, err)
...
//
// 	pieces, err = d.DownloadPieceInfo(123, 50*1024*1024, 16*1024*1024, 32*1024*1024-1)
// 	assert.Equal(t, nil, err)
// 	assert.Equal(t, 1, len(pieces))
// 	assert.Equal(t, piecestore.EncodeSegmentPieceKey(123, uint32(1)), pieces[0].pieceKey)
//
// 	pieces, err = d.DownloadPieceInfo(123, 50*1024*1024, 16*1024*1024-1, 32*1024*1024-1)
// 	assert.Equal(t, nil, err)
// 	assert.Equal(t, 2, len(pieces))
// 	assert.Equal(t, piecestore.EncodeSegmentPieceKey(123, uint32(0)), pieces[0].pieceKey)
...
//
// 	pieces, err = d.DownloadPieceInfo(123, 50*1024*1024, 32*1024*1024+1, 50*1024*1024-1)
// 	assert.Equal(t, nil, err)
// 	assert.Equal(t, 2, len(pieces))
