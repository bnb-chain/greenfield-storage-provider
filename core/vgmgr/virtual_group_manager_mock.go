...
func (mr *MockVirtualGroupManagerMockRecorder) GenerateGlobalVirtualGroupMeta(genPolicy interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) PickGlobalVirtualGroup(vgfID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
