...
type Consensus interface {
	...
	QueryBucketInfoById(ctx context.Context, bucketId uint32) (bucketInfo *storagetypes.BucketInfo, err error)
...
func (*NullConsensus) QueryBucketInfoById(context.Context, uint32) (*storagetypes.BucketInfo, error) {
	return nil, nil
}
