...
// MockAgentUploadPieceHashDB is a mock of AgentUploadPieceHashDB interface.
type MockAgentUploadPieceHashDB struct {
	ctrl     *gomock.Controller
	recorder *MockAgentUploadPieceHashDBMockRecorder
}

// MockAgentUploadPieceHashDBMockRecorder is the mock recorder for MockAgentUploadPieceHashDB.
type MockAgentUploadPieceHashDBMockRecorder struct {
	mock *MockAgentUploadPieceHashDB
}

// NewMockAgentUploadPieceHashDB creates a new mock instance.
func NewMockAgentUploadPieceHashDB(ctrl *gomock.Controller) *MockAgentUploadPieceHashDB {
	mock := &MockAgentUploadPieceHashDB{ctrl: ctrl}
	mock.recorder = &MockAgentUploadPieceHashDBMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAgentUploadPieceHashDB) EXPECT() *MockAgentUploadPieceHashDBMockRecorder {
	return m.recorder
}
